...
import { DELETE_CONFIRMATION_MSG, LIST_OF_CAMPS } from '../constants/constants'
...
const headCells = [
  { id: 'name', numeric: false, disablePadding: true, label: 'Campaign Name (unique)' },
  { id: 'type', numeric: false, disablePadding: false, label: 'Type' },
  { id: 'last_saved', numeric: false, disablePadding: false, label: 'Last Saved' },
...
const EnhancedTableToolbar = props => {
  ...
  const { numSelected, handleDeleteCampaign} = props;
  ...
  return (
    ...
    >
      ...
      {numSelected > 0 ? (
        <Tooltip title="Delete" onClick={handleDeleteCampaign}>
...
export default function Result(props) {
  ...
  const [campId, setCampId] = React.useState(0)
    ...
    if(deleteConfirmModal){
      return(
        <div>
          ...
          title="Confirmation"
          onConfirmed= {props.deleteCampaign}
          selected = {selected}
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        ...
        <EnhancedTableToolbar numSelected={selected.length} handleDeleteCampaign={toggleDeleteConfirmModal} />
        <TableContainer>
          <Table
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.last_saved}</TableCell>
